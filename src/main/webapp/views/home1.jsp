...
<img  src="views/imagev.jpg" alt="" style="margin-left: 500px;"" width="350" height="200">
<button formaction="vote" style="border-radius: 8%; margin-left: 20px;">vote</button>

<br><br><br>

<img  src="views/election_results.png" alt="" style="margin-left: 500px;"" width="350" height="200">
<button formaction="results" style="border-radius: 8%; margin-left: 20px;">results</button>
