...
.bs-example{
    ...
    <body >
<form method="post" action="/candidatereg" modelAttribute="reg">
        ...
        <div class="col-md-9 register-right">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <h3 class="register-heading">Register as a Candidate</h3>
                    <div class="row register-form">
                        ...
                        <div >
                            ...
                            <div class="form-group">
                                <input type="text" name="partyname" class="form-control" placeholder="Your Party Name *" value="" required/>
                            </div>
                            <div >
                                Party Image
